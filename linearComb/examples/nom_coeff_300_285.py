...
plot_nom_fluxes_coeff(reg_FHC, fitter, type_target='FHC', 
                      woHC=True, reg_wo=reg_FHC, ratio=False)
...
plot_nom_fluxes_coeff(reg_RHC, fitter, type_target='RHC', 
                      woHC=True, reg_wo=reg_RHC, ratio=False)
