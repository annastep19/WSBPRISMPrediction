...
// Raw Probability Plots	
	...
	TH2F *_NuEToNuE3f 	= static_cast<TH2F*>(Bob->Get("NuEToNuE3f"));
	TH2F *_NuEToNuMu3f 	= static_cast<TH2F*>(Bob->Get("NuEToNuMu3f"));
	TH2F *_NuEToNuTau3f 	= static_cast<TH2F*>(Bob->Get("NuEToNuTau3f"));
	TH2F *_NuEToNuX3f 	= static_cast<TH2F*>(Bob->Get("NuEToNuX3f"));
	
	
	TH2F *_NuMuToNuE3f 	= static_cast<TH2F*>(Bob->Get("NuMuToNuE3f"));
	TH2F *_NuMuToNuMu3f 	= static_cast<TH2F*>(Bob->Get("NuMuToNuMu3f"));
	TH2F *_NuMuToNuTau3f 	= static_cast<TH2F*>(Bob->Get("NuMuToNuTau3f"));
	TH2F *_NuMuToNuX3f 	= static_cast<TH2F*>(Bob->Get("NuMuToNuX3f"));

	TH2F *_NuTauToNuE3f 	= static_cast<TH2F*>(Bob->Get("NuTauToNuE3f"));
	TH2F *_NuTauToNuMu3f 	= static_cast<TH2F*>(Bob->Get("NuTauToNuMu3f"));
	TH2F *_NuTauToNuTau3f 	= static_cast<TH2F*>(Bob->Get("NuTauToNuTau3f"));
	TH2F *_NuTauToNuX3f 	= static_cast<TH2F*>(Bob->Get("NuTauToNuX3f"));
//------------------- End of Raw Probability Plots	
  ...
  c6->SetLogx(1);
   ...
   c6->SaveAs("./imgs/NuMuToNuTau.png");
